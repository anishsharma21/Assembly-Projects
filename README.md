...
Modern software development is complex and chaotic. Sometimes, it feels like there is unecessary complexity created, and maybe, just maybe, we have jumped the boat. I wanted to return to first-principles and learn computer science from the ground-up, from the lowest layers of abstraction. I wanted to put everything in perspective, so, understanding the basics and building up from there seemed to be a good idea. Hence this repo. I start with some assembly programming, then early programming languages, and finish up with some C/C++.
